...
# REPRESENT A BIER NETWORK -> ONLY THE FIRST 128 NODES ARE Ingress/Egress NODES
# => Only id 1 to 128 can be a destination.
#

#  example command: $python {THIS_FILE} Cogentco.graph     ->  will create 'Cogentco_BIER.py'

from Stateless_MC_logic import ingress_process, failure, failure_list, recover, draw_graph, generate_random_dst, validate_tree
from validation_tests_graph1 import network as network_1
from validation_tests_graph2 import network as network_2
